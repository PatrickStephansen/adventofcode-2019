...
const toCornerCoords = vectorMoves =>
...
const toLineSegments = coordsLists =>
...
const doLineSegmentsIntersect = (l1, l2) =>
...
const getIntersecionPoint = (l1, l2) =>
